...
export async function switchBackend(workspaceId: string, backend: "codex" | "claude") {
  return invoke<{ switched: boolean; backend: string; message: string }>("switch_backend", { workspaceId, backend });
}

export async function getWorkspaceBackend(workspaceId: string) {
  return invoke<string>("get_workspace_backend", { workspaceId });
}

export async function getAllModels() {
  return invoke<any>("get_all_models");
}

export async function getAuthStatus(workspaceId: string) {
  return invoke<any>("get_auth_status", { workspaceId });
}
